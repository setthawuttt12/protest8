...
CREATE TABLE `tb_evadetail` (
  ...
  `detail_eva` text,
  `scorre_member` int DEFAULT NULL,
...
INSERT INTO `tb_indicate` VALUES (1,1,'name_indicate','',5,'y');
...
INSERT INTO `tb_member` VALUES (1,'name','surname','waterE','$2b$10$YWZzW./PMbnbI10paWrNM.XVKA.JOfMEpXjHKS.jr5Li33Bx2viMO','test@hotmail.com','ผู้รับการประเมินผล','1786161029932.png');
...
INSERT INTO `tb_system` VALUES (1,'2025-05-06','2090-06-04',1,1,'y');
...
INSERT INTO `tb_topic` VALUES (1,'test Topis');
...
-- Dump completed on 2026-08-08 14:12:52
