    ...
    <v-container>
        <v-row justify="center">
            <v-col cols="12" md="12">
                <v-card class="pa-2">
                    <v-card-title>
                        <h2 class="text-center">ผลสรุปการประเมินของผู้รับการประเมินผล</h2>
                    </v-card-title>
                    <v-card-text>
                        <v-form>
                            <v-table>
                                ...
                                <tbody>
                                    <tr v-for="(items,index) in result" :key="items.id_eva">
                                        ...
                                        <td class="border text-center">
                                            <center>
                                                <v-btn size="small" :color="bg(items.status_eva)" class="text-center text-white ma-2">{{ items.status_eva === 1 ? 'รอการประเมินตนเอง' : items.status_eva === 2 ? 'รอกรรมการประเมิน' : 'ประเมินสำเร็จ' }}</v-btn>
                                            </center>
                                        </td>
                                    </tr>
                                    <tr>
