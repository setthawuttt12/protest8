                        ...
                        <v-table>
                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :key="items.id_eva">
                                    ...
                                    <td class="text-center border"><v-btn color="blue" class="text-white" size="small"></v-btn></td>
                                    <td class="text-center border">
                                        <!-- <v-btn color="warning" class="text-white" size="small" @click="go(items)">แก้ไข</v-btn>&nbsp; -->
