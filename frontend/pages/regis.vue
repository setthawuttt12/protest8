                    ...
                    <v-card-text class="bg-white">
                        <v-form @submit.prevent="saveMember">
                            ...
                            <v-row>
                                ...
                                <v-col md="6" cols="12">
                                    <v-file-input label="รูปภาพสมาชิก" v-model="pic_user" accept=".png , .jpg" hint="รองรับเฉพาะไฟล์ Png และ Jpg" persistent-hint></v-file-input>
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="12" md="12">
                                    <center>
                                        <v-btn class="text-center ma-3" type="submit" color="primary">สมัครสมาชิก</v-btn>
